...
import static cloudchen.com.sunshine.data.WeatherContract.LocationEntry;
import static cloudchen.com.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitValue = preferences.getString(
        ...
        if (unitValue.equals(mContext.getString(R.string.pref_temperature_unit_default))) {
